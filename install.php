...
<div class="main">
<p class="logo"></p>
<p class="title">emlog <?php echo Option::EMLOG_VERSION ?> For JAE安装程序</p>
<div class="b">
<p class="title2">MySQL数据库设置</p>
<li>
	数据库地址： <br />
    <input name="hostname" type="text" class="input" readonly="readonly" value="<?php echo DB_HOST; ?>">
</li>
<li>
    数据库用户名：<br /><input name="dbuser" type="text" class="input" readonly="readonly" value="<?php echo DB_USER; ?>">
</li>
<li>
    数据库密码：<br /><input name="password" type="text" class="input" readonly="readonly" value="<?php echo DB_PASSWD; ?>">
</li>
<li>
    数据库名：<br />
      <input name="dbname" type="text" class="input" readonly="readonly" value="<?php echo DB_NAME; ?>">
	  <span class="care">(程序不会自动创建数据库，请提前创建一个空数据库或使用已有数据库)</span>
</li>
<li>
    数据库前缀：<br />
  <input name="dbprefix" type="text" class="input" readonly="readonly" value="<?php echo DB_PREFIX; ?>">
...
INSERT INTO {$db_prefix}options (option_name, option_value) VALUES ('bloginfo','自豪的在JAE使用emlog搭建的站点');
